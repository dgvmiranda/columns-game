...
public class PCOFase3 {
	...
	public static void main(String[] args) {
		 ...
		 */
		ClassicalTransformer transf = new ClassicalTransformer(AbstractGame.SIZE_OF_PIECE, symbols[symbols.length - 1]);
		Accomodator fatalAccom = new FatalFallAccomodator(3);
		Game myGame = new MultipleRewardGame(nrLins, nrCols, 2, symbols[symbols.length - 1],
